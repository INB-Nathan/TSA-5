    ...
    <div class="container">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if ($user->id != session()->get('user_id')) : ?>
                                    <a href="/admin/users/delete/<?= $user->id ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this user?')">Delete</a>
                                <?php endif; ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
        ...
        <?php if (isset($totalUsers) && $totalUsers > 0 && isset($totalPages)) : ?>
            <div class="pagination">
                ...
                if ($startPage > 1) : ?>
                    <a href="/admin/users?page=1" class="btn">1</a>
                    <?php if ($startPage > 2) : ?>
                        <span>...</span>
                    <?php endif; ?>
                <?php endif; ?>
                ...
                <?php if ($endPage < $totalPages) : ?>
                    <?php if ($endPage < $totalPages - 1) : ?>
                        <span>...</span>
                    <?php endif; ?>
                    <a href="/admin/users?page=<?= $totalPages ?>" class="btn"><?= $totalPages ?></a>
                <?php endif; ?>
